      ...
      >
        <div className="relative overflow-hidden flex items-center justify-center w-full">
          <Image
            ...
            width={800}
            height={800}
            className="rounded-[12px] w-[300] h-[300px] sm:w-[650px] sm:h-[450px] md:w-[500px] md:h-[300px] lg:w-[800px] lg:h-[400px] object-cover"
          />
          <Link
          ...
          <Link
            data-disable-nprogress={true}
            href={works.link}
            className="absolute z-20 md:text-[48px] text-[32px] max-md:border-t-2 max-md:border-b-2 font-semibold text-gray-50 opacity-0 group-hover:opacity-100 transition-all duration-700 tracking-wider scale-90 group-hover:scale-100 select-none"
          >
            Visit
          </Link>
        ...
        <div className="flex flex-col p-4 py-6 z-10">
          <div className="flex flex-col">
            ...
            <h1 className="lg:text-[24px] md:text-[20px] text-[18px] font-medium">
              {works.name}
            </h1>
          </div>
          <p className="md:text-[16px] text-[14px] text-gray-500 max-w-xl mt-2">
            {works.desc}
          </p>
          <div className="mt-10">
        ...
        <Image
          ...
          width={200}
          height={200}
          className="absolute bottom-0 right-0 opacity-20 translate-x-10 translate-y-20"
        />
      </motion.div>
    </div>
  );
