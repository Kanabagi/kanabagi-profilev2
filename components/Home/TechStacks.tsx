...
const TechStacks = () => {
    ...
    return (
        <motion.section
            ...
            className='relative overflow-hidden min-h-screen flex justify-center items-center pt-10'>
            <div className='wrapper flex flex-col items-center justify-center gap-6 z-10'>
                ...
                <motion.div
                    ...
                    className='border-2 border-gray-800 md:translate-y-10 p-6 flex md:justify-between md:items-center gap-6 rounded-[12px] w-full max-md:flex-col max-md:mt-4 mt-10'>
